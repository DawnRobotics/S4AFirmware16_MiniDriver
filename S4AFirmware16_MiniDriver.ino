...
void configurePins()
{
  ...
  arduinoPins[5].type=servomotor;         // pin 7 S4A
  arduinoPins[6].type=servomotor;         // pin 8 S4A
  arduinoPins[7].type=digital;            // pin 10 S4A
  arduinoPins[8].type=digital;            // pin 11 S4A
  arduinoPins[9].type=pwm;
  arduinoPins[10].type=pwm;               // pin 5 S4A
  arduinoPins[11].type=pwm;               // pin 6 S4A
